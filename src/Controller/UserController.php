...
class UserController extends AbstractController
{
    ...
    public function new(Request $request, UserPasswordEncoderInterface $passwordEncoder, UserRepository $userRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Ajout d\'utilisateur effectuée avec succès.');
    ...
    public function edit(Request $request, User $user, UserRepository $userRepository, UserPasswordEncoderInterface $passwordEncoder): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Modification d\'utilisateur effectuée avec succès.');
    ...
    public function delete(Request $request, User $user, UserRepository $userRepository): Response
    {
        ...
        $this->addFlash('success', 'Suppression d\'utilisateur effectuée avec succès.');
